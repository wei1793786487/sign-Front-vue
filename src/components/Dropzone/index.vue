...
export default {
  ...
  mounted() {
    ...
    this.dropzone = new Dropzone(element, {
      ...
      previewTemplate:
        '<div class="dz-preview dz-file-preview"> <div class="dz-filename" style="text-align:center" ><span data-dz-name></span></div> <div class="dz-image" style="width:' +
        this.thumbnailWidth +
        "px;height:" +
    ...
    this.dropzone.on("success", file => {
      ...
      if (response.code === 200) {
        ...
        this.$message({
          message: file.name + response.message,
          duration: 2000,
          showClose: true,
          type: "warning"
        });
